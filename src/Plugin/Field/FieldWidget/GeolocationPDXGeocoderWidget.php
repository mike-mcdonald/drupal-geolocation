...
use Drupal\geolocation\ESRIMapsDisplayTrait;
 ...
 *
 * @FieldWidget(
 *   id = "geolocation_pdxgeocoder",
 *   label = @Translation("Geolocation ESRI - PDX Geocoder and ESRI Map"),
 *   field_types = {
 *     "geolocation"
 *   }
 * )
 */
class GeolocationPDXGeocoderWidget extends WidgetBase implements ContainerFactoryPluginInterface {

  use ESRIMapsDisplayTrait;
